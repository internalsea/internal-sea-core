...
def test_calculate_next_run_at_custom_keeps_existing() -> None:
    base = datetime(2026, 6, 12, 10, 0, tzinfo=timezone.utc)
    existing = datetime(2026, 7, 1, 8, 0, tzinfo=timezone.utc)
