...
class DataProductService:
    ...
    async def get_data_product(self, data_product_id: uuid.UUID, *, company_id: uuid.UUID | None = None) -> DataProductRead:
    ...
    async def delete_data_product(self, data_product_id: uuid.UUID, *, company_id: uuid.UUID | None = None) -> None:
        data_product = await self._repository.get_by_id(data_product_id)
        if data_product is None:
            raise DataProductNotFoundError(data_product_id)
        if company_id is not None:
